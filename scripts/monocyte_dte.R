...
counts = read.table("/sc/hydra/projects/pd-omics/mynd/analyses/analysis_9_19_19/mynd.counts.proteincoding.txt", header = TRUE, check.names = FALSE)
...
write.table(resPD, 'rsem.mynd.protein_coding.txt')
