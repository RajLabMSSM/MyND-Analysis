...
p + geom_point() + scale_color_manual(values =c("black", "red")) + geom_hline(yintercept = 0.006, size = 1, color = 'red') + geom_hline(yintercept = 0.02, size = 1, color = 'blue') + theme_light()
