...
getResiduals <- function(exprLine) {
  ourCovRegression <- lm(exprLine ~  mynd_metadata$rin_value +  mynd_metadata$rna_batch +  mynd_metadata$gender + mynd_metadata$age + mynd_metadata$PCT_USABLE_BASES + mynd_metadata$mds1 + mynd_metadata$mds2 + mynd_metadata$mds3 + mynd_metadata$mds4);
...
cov = t(resid)
autoplot(prcomp(cov), data = mynd_metadata, main = "rna_batch", colour = "rna_batch", label = T)
